            ...
            >
              <Container>
                ...
                <Menu.Item position='right'>
                  ...
                  <Button href='/login'as='a' inverted={!fixed} primary={fixed} style={{ marginLeft: '0.5em' }}>
                    Sign Up
                  </Button>
                </Menu.Item>
              </Container>
  ...
  <ResponsiveContainer>
      ...
      <Grid container stackable verticalAlign='middle'>
        <Grid.Row>
          <Grid.Column width={8} style={{ paddingBottom: '5em', paddingTop: '5em' }}>
            ...
            <Header as='h3' style={{ fontSize: '2em' }}>
              A one stop shop for info at your favorite N. American Resorts
            </Header>
            <p style={{ fontSize: '1.33em' }}>
      ...
      <Grid celled='internally' columns='equal' stackable>
        <Grid.Row textAlign='center'>
          ...
          <Grid.Column style={{ paddingBottom: '5em', paddingTop: '5em' }}>
            ...
            <p style={{ fontSize: '1.33em' }}>
              <Image avatar src='https://upload.wikimedia.org/wikipedia/commons/thumb/e/ea/Freestyle_skiing_jump2.jpg/281px-Freestyle_skiing_jump2.jpg' />
    ...
    <Segment style={{ padding: '8em 0em' }} vertical>
      <Container text>
        ...
        <Header as='h3' style={{ fontSize: '2em' }}>
          Did We Tell You About How Bananas We Are?
        </Header>
        <p style={{ fontSize: '1.33em' }}>
